/**
 * Project Name:umale
 * File Name:NodeTakeevidenceServiceImplTest
 ...
 * @author bridge
 * @version
 * @className NodeTakeevidenceServiceImplTest
 * @description
 * @date 2019/5/23 14:22
 * @since JDK 1.8
 */
