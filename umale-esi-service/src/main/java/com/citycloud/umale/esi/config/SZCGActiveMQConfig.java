...
public class SZCGActiveMQConfig {
    ...
    @Value("${szcg.activemq.push.topic.name}")
    private String topicName;

    @Value("${szcg.activemq.topic.clientid}")
    private String clientID;

    @Value("${jlsyl.activemq.push.topic.name}")
    private String jlsylTopicName;
    ...
    @Bean
    public Topic jlsylTopic(){
        return new ActiveMQTopic(jlsylTopicName);
    }
